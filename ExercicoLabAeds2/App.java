...
public class App {
    ...
    public static void main(String[] args) {
        ...
        *  com o algoritmo InsertionSort */
        ...
        InsertionSort<Integer> insection = new InsertionSort<>();

        Integer[] VetorOrdenadoInsertion = bolha.ordenar(vetor);
        ...
        System.out.println("\nVetor ordenado método Bolha:");
        System.out.println(Arrays.toString(vetorOrdenadoBolha));
        System.out.println("Comparações: " + insection.getComparacoes());
        System.out.println("Movimentações: " + insection.getMovimentacoes());
        System.out.println("Tempo de ordenação (ms): " + insection.getTempoOrdenacao());
